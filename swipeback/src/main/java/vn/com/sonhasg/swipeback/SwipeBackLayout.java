...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, vn.com.sonhasg.swipeback.R.attr.SwipeBackLayoutStyle);
    }
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, vn.com.sonhasg.swipeback.R.styleable.SwipeBackLayout, defStyle,
                vn.com.sonhasg.swipeback.R.style.SwipeBackLayout);

        int edgeSize = a.getDimensionPixelSize(vn.com.sonhasg.swipeback.R.styleable.SwipeBackLayout_edge_size, -1);
        if (edgeSize > 0)
            setEdgeSize(edgeSize);
        int mode = EDGE_FLAGS[a.getInt(vn.com.sonhasg.swipeback.R.styleable.SwipeBackLayout_edge_flag, 0)];
        setEdgeTrackingEnabled(mode);

        int shadowLeft = a.getResourceId(vn.com.sonhasg.swipeback.R.styleable.SwipeBackLayout_shadow_left,
                vn.com.sonhasg.swipeback.R.drawable.shadow_left);
        int shadowRight = a.getResourceId(vn.com.sonhasg.swipeback.R.styleable.SwipeBackLayout_shadow_right,
                vn.com.sonhasg.swipeback.R.drawable.shadow_right);
        int shadowBottom = a.getResourceId(vn.com.sonhasg.swipeback.R.styleable.SwipeBackLayout_shadow_bottom,
                vn.com.sonhasg.swipeback.R.drawable.shadow_bottom);
